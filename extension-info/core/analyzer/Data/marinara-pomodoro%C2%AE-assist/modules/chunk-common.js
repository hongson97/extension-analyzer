    ...
    ["chunk-common"], {
        "0567": function(e, t, s) {
            ...
            class r {
                ...
                average_stat(e) {
                    return chrome.i18n.getMessage("average_stat", [e])
                }
                get battle_horn() {
                ...
                browser_action_tooltip(e, t) {
                    return chrome.i18n.getMessage("browser_action_tooltip", [e, t])
                }
                ...
                daily_tooltip(e, t, s) {
                    return chrome.i18n.getMessage("daily_tooltip", [e, t, s])
                }
                get date_format() {
                ...
                error_saving_settings(e) {
                    return chrome.i18n.getMessage("error_saving_settings", [e])
                }
                ...
                group_pomodoros_hour_buckets(e) {
                    return chrome.i18n.getMessage("group_pomodoros_hour_buckets", [e])
                }
                group_pomodoros_minute_buckets(e) {
                    return chrome.i18n.getMessage("group_pomodoros_minute_buckets", [e])
                }
                get heatmap_date_format() {
                    return chrome.i18n.getMessage("heatmap_date_format", [])
                }
                heatmap_tooltip(e, t) {
                    return chrome.i18n.getMessage("heatmap_tooltip", [e, t])
                }
                get height() {
                ...
                hr_suffix(e) {
                    return chrome.i18n.getMessage("hr_suffix", [e])
                }
                get import() {
                ...
                import_failed(e) {
                    return chrome.i18n.getMessage("import_failed", [e])
                }
                in_month(e) {
                    return chrome.i18n.getMessage("in_month", [e])
                }
                ...
                last_9_months(e) {
                    return chrome.i18n.getMessage("last_9_months", [e])
                }
                ...
                min_suffix(e) {
                    return chrome.i18n.getMessage("min_suffix", [e])
                }
                get minutes() {
                ...
                n_minutes(e) {
                    return chrome.i18n.getMessage("n_minutes", [e])
                }
                get never() {
                ...
                pomodoro_count_many(e) {
                    return chrome.i18n.getMessage("pomodoro_count_many", [e])
                }
                ...
                pomodoros_completed_today(e) {
                    return chrome.i18n.getMessage("pomodoros_completed_today", [e])
                }
                pomodoros_imported(e) {
                    return chrome.i18n.getMessage("pomodoros_imported", [e])
                }
                pomodoros_until_long_break(e) {
                    return chrome.i18n.getMessage("pomodoros_until_long_break", [e])
                }
                get pulse() {
                ...
                time_remaining(e) {
                    return chrome.i18n.getMessage("time_remaining", [e])
                }
                get timer_paused() {
                ...
                weekly_tooltip(e, t) {
                    return chrome.i18n.getMessage("weekly_tooltip", [e, t])
                }
                get when_complete() {
        ...
        "0bad": function(e, t, s) {
            ...
            function i(e) {
                return e.searchParams.sort(), `${e.origin}${e.pathname.replace(/\/$/,"")}${e.searchParams}`.toLowerCase()
            }
            class o {
                static async show(e, t, s = {}) {
                    let A = new URL(e),
                        a = i(A),
                        g = chrome.extension.getViews();
                    for (let r of g) {
                        if (i(new URL(r.location.href)) !== a) continue;
                        let e = await new Promise(e => r.chrome.tabs.getCurrent(t => e(t.id)));
                        return r.location.hash = A.hash, new o(e)
                    }
                    if (t === n.Tab) {
                        let t = await r["a"].tabs.create({
                            url: e,
                            active: !1,
                            ...s
                        });
                    ...
                    if (t === n.Window) {
                        let t = await r["a"].windows.create({
                            url: e,
                            type: "popup",
                            ...s
                        });
                        return new o(t.tabs[0].id)
                    }
                ...
                constructor(e) {
                    this.tabId = e;
                    const t = this;
                    chrome.tabs.onRemoved.addListener(function e(s) {
                        s === t.tabId && (chrome.tabs.onRemoved.removeListener(e), t.tabId = null)
                    })
                }
                focus() {
                    if (!this.tabId) return;
                    const e = e => chrome.windows.update(e.windowId, {
                            focused: !0
                        }),
                        t = t => {
                            try {
                ...
                close() {
                    this.tabId && chrome.tabs.remove(this.tabId, () => {})
                }
            }
        },
        "0daf": function(e, t, s) {
            ...
            class o extends n.a {
                constructor(e, t) {
                    super(), this.state = i.Stopped, this.duration = e, this.tick = t, this.tickInterval = null, this.expireTimeout = null, this.checkpointStartAt = null, this.checkpointElapsed = 0
                }
                observe(e) {
                    e.onStart && this.on("start", (...t) => e.onStart(...t)), e.onStop && this.on("stop", (...t) => e.onStop(...t)), e.onPause && this.on("pause", (...t) => e.onPause(...t)), e.onResume && this.on("resume", (...t) => e.onResume(...t)), e.onTick && this.on("tick", (...t) => e.onTick(...t)), e.onExpire && this.on("expire", (...t) => e.onExpire(...t))
                }
                get isStopped() {
                ...
                get elapsed() {
                    let e = 0;
                    return this.checkpointStartAt && this.isRunning && (e = (Date.now() - this.checkpointStartAt) / 1e3), this.checkpointElapsed + e
                }
                get status() {
                    return {
                        state: this.state,
                ...
                start() {
                    this.isStopped && (this.setExpireTimeout(this.duration), this.setTickInterval(this.tick), this.state = i.Running, this.checkpointStartAt = Date.now(), this.emit("start", this.status))
                }
                stop() {
                    this.isStopped || (clearInterval(this.tickInterval), clearTimeout(this.expireTimeout), this.tickInterval = null, this.expireTimeout = null, this.checkpointStartAt = null, this.checkpointElapsed = 0, this.state = i.Stopped, this.emit("stop", this.status))
                }
                pause() {
                    if (!this.isRunning) return;
                    clearInterval(this.tickInterval), clearTimeout(this.expireTimeout);
                    let e = (Date.now() - this.checkpointStartAt) / 1e3;
                    this.checkpointElapsed += e, this.state = i.Paused, this.emit("pause", this.status)
                }
                resume() {
                    this.isPaused && (this.setExpireTimeout(this.remaining), this.setTickInterval(this.tick), this.state = i.Running, this.checkpointStartAt = Date.now(), this.emit("resume", this.status))
                }
                restart() {
                ...
                setExpireTimeout(e) {
                    this.expireTimeout = setTimeout(() => {
                        clearInterval(this.tickInterval), clearTimeout(this.expireTimeout), this.tickInterval = null, this.expireTimeout = null, this.checkpointStartAt = Date.now(), this.checkpointElapsed = this.duration, this.state = i.Stopped, this.emit("expire", this.status)
                    }, 1e3 * e)
                }
                setTickInterval(e) {
            ...
            class g extends n.a {
                constructor(e, t = a.Focus, s = o) {
                    super(), this.timerType = s, this.advanceTimer = !1, this.pomodoros = 0, this.settings = e, this.phase = t
                }
                _updateTimer() {
                    let {
                        duration: e
                    } = {
                        [a.Focus]: this.settings.focus,
                        [a.ShortBreak]: this.settings.shortBreak,
                        [a.LongBreak]: this.settings.longBreak
                    } [this.phase];
                    this.timer && (this.timer.stop(), this.timer.removeAllListeners()), this.timer = new this.timerType(Math.floor(60 * e), 60), this.timer.observe(this)
                }
                get phase() {
                    return this._phase
                }
                set phase(e) {
                    if (!this.hasLongBreak && e === a.LongBreak) throw new Error("No long break interval defined.");
                    this._phase = e, this._updateTimer(), this.advanceTimer = !1
                }
                get nextPhase() {
                    return this.phase === a.ShortBreak || this.phase === a.LongBreak ? a.Focus : this.hasLongBreak && 0 === this.pomodorosUntilLongBreak ? a.LongBreak : a.ShortBreak
                }
                get hasLongBreak() {
                ...
                get pomodorosUntilLongBreak() {
                    ...
                    return e ? e - (this.pomodoros - 1) % e - 1 : null
                }
                get remaining() {
                ...
                dispose() {
                    this.timer.stop(), this.timer.removeAllListeners()
                }
                startCycle() {
                    this.pomodoros = 0, this.phase = a.Focus, this.start()
                }
                startFocus() {
                    this.phase = a.Focus, this.start()
                }
                startShortBreak() {
                    this.phase = a.ShortBreak, this.start()
                }
                startLongBreak() {
                    this.phase = a.LongBreak, this.start()
                }
                start() {
                    this.advanceTimer && (this._phase = this.nextPhase, this.advanceTimer = !1), this._updateTimer(), this.timer.start()
                }
                pause() {
                ...
                onExpire(e) {
                    this.phase === a.Focus && this.pomodoros++, this.advanceTimer = !0, this.emit("expire", {
                        phase: this.phase,
                        nextPhase: this.nextPhase,
                        ...e
                    })
        ...
        2354: function(e, t, s) {
            ...
            function n(e, t) {
                return new Promise(async (s, A) => {
                    let n = await r["a"].files.readBinary(t);
                    e.decodeAudioData(n, e => s(e), e => A(e))
                })
            }
            ...
            class o {
                constructor(e, t, s) {
                    this.buffers = t, this.period = s, this.context = e, this.interval = null, this.scheduledTime = 0, this.soundIndex = 0, this.contextLock = new A["a"]
                }
                static async create(e, t) {
                    let s = new AudioContext;
                    await s.suspend();
                    let r = [];
                    for (let A of e) {
                        let e = await n(s, A);
                ...
                async start() {
                    await this.contextLock.exclusive(async () => {
                        if (!this.context || this.interval) return;
                        const e = 15e3,
                            t = Math.max(2, e / this.period * 2),
                            s = () => {
                                let e = i(1e3 * this.context.currentTime, this.period) + this.period * t;
                                while (this.scheduledTime < e) {
                                    if (this.scheduledTime += this.period, this.scheduledTime <= 1e3 * this.context.currentTime) continue;
                                    let e = this.context.createBufferSource();
                                    e.buffer = this.buffers[this.soundIndex], this.soundIndex = (this.soundIndex + 1) % this.buffers.length, e.connect(this.context.destination), e.start(this.scheduledTime / 1e3)
                                }
                            };
                        this.interval = setInterval(() => s(), e), s(), await this.context.resume()
                    })
                }
                async stop() {
                    await this.contextLock.exclusive(async () => {
                ...
                async close() {
                    await this.contextLock.exclusive(async () => {
                        this.context && (await this._stop(), await this.context.close(), this.context = null)
                    })
                }
                async _stop() {
                    this.context && this.interval && (clearInterval(this.interval), this.interval = null, await this.context.suspend())
                }
            }
            var a = o;
            class g {
                static async create(e) {
                    ...
                    await t.suspend();
                    let s = e(t);
                    return s.connect(t.destination), new g(t)
                }
                constructor(e) {
                    this.context = e
                }
                ...
                async close() {
                    this.context && (await this.stop(), await this.context.close(), this.context = null)
                }
            }

            function c(e) {
                const t = 4096;
                let s = e.createScriptProcessor(t, 1, 1);
                return s.onaudioprocess = e => {
                    let s = e.outputBuffer.getChannelData(0);
                    for (let r = 0; r < t; r++) s[r] = 2 * Math.random() - 1, s[r] *= .01
                }, s
            }
            ...
            function h(e) {
                ...
                let s, r, A, n, i, o, a;
                s = r = A = n = i = o = a = 0;
                let g = e.createScriptProcessor(t, 1, 1);
                return g.onaudioprocess = e => {
                    let g = e.outputBuffer.getChannelData(0);
                    for (let c = 0; c < t; c++) {
                        let e = 2 * Math.random() - 1;
                        s = .99886 * s + .0555179 * e, r = .99332 * r + .0750759 * e, A = .969 * A + .153852 * e, n = .8665 * n + .3104856 * e, i = .55 * i + .5329522 * e, o = -.7616 * o - .016898 * e, g[c] = s + r + A + n + i + o + a + .5362 * e, g[c] *= .005, a = .115926 * e
                    }
                }, g
            }
            ...
            function u(e) {
                const t = 4096;
                let s = 0,
                    r = e.createScriptProcessor(t, 1, 1);
                return r.onaudioprocess = e => {
                    let r = e.outputBuffer.getChannelData(0);
                    for (let A = 0; A < t; A++) {
                        let e = 2 * Math.random() - 1;
                        r[A] = (s + .02 * e) / 1.02, s = r[A], r[A] *= .2
                    }
                }, r
            }
            async function m(e) {
                ...
                if (e.metronome) {
                    let {
                        files: t,
                        bpm: s
                    } = e.metronome, r = 60 / s * 1e3;
                    return await a.create(t, r)
                }
                let t = {
                    "white-noise": c,
                    "pink-noise": h,
                ...
                if (!t) throw new Error("Invalid procedural timer sound.");
                return await g.create(t)
            }
            t["a"] = m
        },
        "48d2": function(e, t, s) {
            ...
            t["a"] = class {
                constructor() {
                    this.queue = [], this.pending = !1
                }
                async exclusive(e) {
                    try {
                        var t = await this.acquire();
                        return await e()
                    } finally {
                        t()
                    }
                ...
                async acquire() {
                    ...
                    return this.pending ? (await new Promise(e => this.queue.push(e)), e) : (this.pending = !0, e)
                }
            }
        },
        "57d7": function(e, t, s) {
            t = e.exports = s("2350")(!1), t.push([e.i, '@font-face{font-family:Source Sans Pro;font-style:normal;font-weight:400;src:local("Source Sans Pro Regular"),local("SourceSansPro-Regular"),url(/fonts/SourceSansPro-Regular.ttf) format("truetype")}@font-face{font-family:Source Sans Pro;font-style:normal;font-weight:600;src:local("Source Sans Pro SemiBold"),local("SourceSansPro-SemiBold"),url(/fonts/SourceSansPro-SemiBold.ttf) format("truetype")}body,button,html,input,select{font:15px Source Sans Pro,sans-serif}', ""])
        },
        "583d": function(e, t, s) {
            "use strict";
            s.d(t, "b", function() {
            ...
            function i(e, t) {
                return e.toLocaleString(navigator.language, {
            ...
            function a(e) {
                return 0 === e ? r["a"].pomodoro_count_zero : 1 === e ? r["a"].pomodoro_count_one : r["a"].pomodoro_count_many(e.toLocaleString())
            }

            function g(e) {
                let t = Math.floor(e / 60);
                return t < 10 && (t = "0" + t), e = Math.floor(e % 60), e < 10 && (e = "0" + e), `${t}:${e}`
            }
        ...
        7906: function(e, t, s) {
            t = e.exports = s("2350")(!1), t.push([e.i, '@font-face{font-family:fontello;src:url("data:application/octet-stream;base64,") format("woff"),url("data:application/octet-stream;base64,") format("truetype")}[class*=" icon-"]:before,[class^=icon-]:before{font-family:fontello;font-style:normal;font-weight:400;speak:none;display:inline-block;text-decoration:inherit;width:1em;margin-right:.2em;text-align:center;font-variant:normal;text-transform:none;line-height:1em;margin-left:.2em}.icon-play:before{content:"\\E801"}.icon-circle:before{content:"\\F111"}', ""])
        },
        "9f6b": function(e, t, s) {
            "use strict";
            s.d(t, "a", function() {
            ...
            function n() {
                let e = [{
                    ...
                    name: A["a"].digital_watch,
                    file: "be75f155.mp3"
                }, {
                    name: A["a"].analog_alarm_clock,
                    file: "0f034826.mp3"
                }, {
                    name: A["a"].digital_alarm_clock,
                    file: "fee369b7.mp3"
                }, {
                    name: A["a"].electronic_chime,
                    file: "28d6b5be.mp3"
                }, {
                    name: A["a"].gong_1,
                    file: "8bce59b5.mp3"
                    ...
                    name: A["a"].robot_blip_1,
                    file: "bd50add0.mp3"
                }, {
                    name: A["a"].robot_blip_2,
                    file: "36e93c27.mp3"
                }, {
                    name: A["a"].ship_bell,
                    file: "9404f598.mp3"
                    ...
                    name: A["a"].reception_bell,
                    file: "54b867f9.mp3"
                }, {
                    name: A["a"].toaster_oven,
                    file: "a258e906.mp3"
                }, {
                    name: A["a"].battle_horn,
                    file: "88736c22.mp3"
                }, {
                    name: A["a"].ding,
                    file: "1a5066bd.mp3"
                ...
                for (let t of e) t.file = `/audio/${t.file}`;
                return e
            }
            ...
            function i() {
                let e = [{
                    name: A["a"].stopwatch,
                    files: ["4cf03078.mp3", "edab7b0d.mp3"]
                }, {
                    name: A["a"].wristwatch,
                    files: ["8dc834f8.mp3", "831a5549.mp3"]
                }, {
                    name: A["a"].clock,
                    files: ["af607ff1.mp3", "fd23aaf3.mp3"]
                }, {
                    name: A["a"].wall_clock,
                    files: ["6103cd58.mp3", "cad167ea.mp3"]
                }, {
                    name: A["a"].desk_clock,
                    files: ["6a981bfc.mp3", "fd64de98.mp3"]
                }, {
                    name: A["a"].wind_up_clock,
                    files: ["bc4e3db2.mp3", "f9efd11b.mp3"]
                }, {
                    name: A["a"].antique_clock,
                    files: ["875326f9.mp3", "cba5f173.mp3"]
                }, {
                    name: A["a"].small_clock,
                    files: ["89dafd3e.mp3", "0a0ec499.mp3"]
                }, {
                    name: A["a"].large_clock,
                    files: ["2122d2a4.mp3", "a273ba0c.mp3"]
                }, {
                    name: A["a"].wood_block,
                    files: ["ad6eac9e.mp3"]
                }, {
                    name: A["a"].metronome,
                    files: ["bced7c21.mp3", "9bd67f7e.mp3"]
                }, {
                    name: A["a"].pulse,
                    files: ["fe5d2a62.mp3"]
                }];
                for (let t of e) t.files = t.files.map(e => `/audio/${e}`);
                return e
            }
            async function o(e) {
                if (!e) return;
                ...
                s.connect(t.destination), s.buffer = await new Promise(async (s, A) => {
                    let n = await r["a"].files.readBinary(e);
                    t.decodeAudioData(n, e => s(e), e => A(e))
                }), await new Promise(e => {
                    s.onended = () => {
                        t.close(), e()
                    }, s.start()
        ...
        a0ef: function(e, t, s) {
            ...
            class i {
                static async create(e) {
                    const t = async t => {
                        ...
                        return n(e => {
                            chrome.tabs.create(a, e)
                        })
                    };
                    try {
                        let e = await A.windows.getLastFocused({
                            windowTypes: ["normal"]
                        });
                        if (e) return t(e.id)
                    } catch (o) {
            ...
            class o {
                static async getAll(e) {
                    return n(t => {
                        chrome.windows.getAll(e, t)
                    })
                }
                static async getLastFocused(e) {
                    return n(t => {
                        chrome.windows.getLastFocused(e, t)
                    })
                }
                static async create(e) {
                    if ("maximized" === e.state && "popup" === e.type) {
                        let {
                            os: t
                        } = await A.runtime.getPlatformInfo();
                        t === chrome.runtime.PlatformOs.MAC && (e = {
                            ...e,
                    ...
                    return n(t => {
                        chrome.windows.create(e, t)
                    })
                }
                static async update(e, t) {
                    return n(s => {
                        chrome.windows.update(e, t, s)
                    })
                }
            }
            class a {
                static async create(e) {
                    return n(t => {
                        try {
                            ...
                            chrome.notifications.create("", r, t)
                        }
                    })
                }
            }
            class g {
                ...
                static get sync() {
                    return this._sync || (this._sync = new g(chrome.storage.sync)), this._sync
                }
                static get local() {
                    return this._local || (this._local = new g(chrome.storage.local)), this._local
                }
            }
            class c {
        ...
        a2b8: function(e, t, s) {
            ...
            class r {
                constructor(e, t) {
                    Object.is(t, void 0) || (this.value = t), this.symbol = Symbol.for(e), Object.freeze(this)
            ...
            class A {
                constructor(e) {
                    for (let t in e) this[t] = new r(t, e[t]);
                    Object.freeze(this)
                }
                keys() {
                ...
                contains(e) {
                    return e instanceof r && this[Symbol.keyFor(e.symbol)] === symbol
                }
            }
            t["a"] = A
        },
        a925: function(e, t, s) {
            ...
            const n = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"],
                ...
                o = i.map(e => r["a"][e]),
                a = i.map(e => r["a"][`${e}_short`]),
                g = n.map(e => r["a"][e]),
                c = n.map(e => r["a"][`${e}_short`]),
                h = Object(A["i"])({
                    decimal: r["a"].decimal_separator,
                    thousands: r["a"].thousands_separator,
                    grouping: [3],
                    dateTime: r["a"].date_time_format,
                    date: r["a"].date_format,
                    time: r["a"].time_format,
                    periods: [r["a"].time_period_am, r["a"].time_period_pm],
                    days: o,
                    shortDays: a,
                    months: g,
                    shortMonths: c
        ...
        b376: function(e, t, s) {
            ...
            class n extends A["a"] {
                constructor(e, t) {
                    super(), this.properties = e, this.page = t
                }
                async getProperties() {
                    return setTimeout(() => this.page.focus(), 0), this.properties
                }
            }
            class i {
                static async show(e, t, s, A, n) {
                    let o = await r["b"].show(chrome.extension.getURL("modules/expire.html"), r["a"].Tab);
                    return new i(o, e, t, s, A, n)
                }
                constructor(e, t, s, r, i, o) {
                    ...
                    this.service = new n(a, e), A["b"].register(this.service);
                    const g = this;
                    chrome.tabs.onRemoved.addListener(function t(s) {
                        s === e.tabId && (A["b"].unregister(g.service), chrome.tabs.onRemoved.removeListener(t))
                    })
                }
                close() {
                    this.page.close()
        ...
        bb42: function(e, t, s) {
            ...
            class n {
                constructor() {
                    this.services = {}, chrome.runtime.onMessage.addListener(this.onMessage.bind(this))
                }
                static get instance() {
                    return this._instance || (this._instance = new n), this._instance
                }
                static register(e) {
                    return this.instance.register(e)
                }
                static async invoke(e) {
                    return await this.instance.invoke(e)
                }
                register(e) {
                    return this.services[e.constructor.name] = e, e
                }
                unregister(e) {
                    return delete this.services[e.constructor.name], e
                }
                async invoke({
                    serviceName: e,
                    methodName: t,
                    ...
                    let r = this.services[e];
                    if (r) {
                        if (r[t]) return await r[t](...s);
                        throw new Exception(`Invalid service request: ${e}.${t}.`)
                    }
                ...
                onMessage({
                    ...
                    let n = this.services[e];
                    if (n && void 0 !== t) return n[t] ? ((async () => {
                        try {
                            A({
                                result: await n[t](...s)
                            })
                        ...
                        error: `Invalid service request: ${e}.${t}.`
                    }), !0)
                }
            }
            class i extends A.a {
                constructor(e) {
                    super(), this.serviceName = e, this.listenerCount = 0, this.on("removeListener", () => {
                        0 === --this.listenerCount && chrome.runtime.onMessage.removeListener(this.onMessage)
                    }), this.on("newListener", () => {
                        1 === ++this.listenerCount && (this.onMessage = this._onMessage.bind(this), chrome.runtime.onMessage.addListener(this.onMessage))
                    })
                }
                dispose() {
                    this.removeAllListeners(), chrome.runtime.onMessage.removeListener(this.onMessage)
                }
                get(e, t, s) {
                ...
                _onMessage({
                    ...
                    e === this.serviceName && void 0 !== t && this.emit(t, ...s)
                }
            }
            class o {
                constructor() {
                    this.clients = {}, this.serviceName = this.constructor.name
                }
                emit(e, ...t) {
                ...
                static get proxy() {
                    const e = this.name,
                        t = () => new Proxy(function() {}, new i(e)),
                        s = {
                            construct(e, s) {
                                return t()
                            },
                            get(e, s, r) {
                                if ("once" === s) return new Proxy(function() {}, {
                                    get(e, s, r) {
                                        return (...e) => {
                                            let r = t();
                                            try {
        ...
        dcb2: function(e, t, s) {
            ...
            class i extends A["a"] {
                constructor(e) {
                    super(), this.settingsManager = e
                }
                async getSettings() {
                    return await this.settingsManager.get()
                }
                async setSettings(e) {
                    this._isValid(e) && await this.settingsManager.set(e)
                }
                _isValid(e) {
                    let t = [e.focus, e.shortBreak, e.longBreak].every(this._isPhaseValid);
                    if (!t) return !1;
                    let s = e.autostart && e.autostart.time;
                ...
                _isPhaseValid(e) {
                    ...
                    if (isNaN(t) || t <= 0 || t > 999) return !1;
                    if (s && s.metronome) {
                        let {
                            bpm: e
                        } = s.metronome;
                        if (isNaN(e) || e <= 0 || e > 1e3) return !1
                    }
                    if ("window" === r.host) {
                        let {
                            resolution: e
                        } = r, t = "fullscreen" === e || Array.isArray(e) && 2 === e.length && e.every(Number.isInteger);
                        if (!t) return !1
                    }
                    return !0
                }
            ...
            class o extends A["a"] {
                constructor(e) {
                    super(), this.history = e
                }
                async getStats(e) {
                    return await this.history.stats(e)
                }
                async getCSV() {
                ...
                async merge(e) {
                    return await this.history.merge(e)
                }
                async clearHistory() {
            ...
            class a extends A["a"] {
                constructor(e) {
                    super(), this.timer = e, this.timer.observe(this)
                }
                async start() {
                    this.timer.start()
                }
            ...
            class c extends A["a"] {
                async showPage(e) {
                    let t = chrome.runtime.getManifest(),
                        s = chrome.extension.getURL(t.options_page + "#/" + e),
                        r = await n["b"].show(s, n["a"].Tab);
                    r.focus()
                }
