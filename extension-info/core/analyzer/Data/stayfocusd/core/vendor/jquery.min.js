    ...
    Qe.optgroup = Qe.option, Qe.tbody = Qe.tfoot = Qe.colgroup = Qe.caption = Qe.thead, Qe.th = Qe.td, oe.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), l = ($e.exec(o) || ["", ""])[1].toLowerCase(), c = Qe[l] || Qe._default, s.innerHTML = c[1] + o.replace(We, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        html: function(e) {
            return je(this, function(e) {
                ...
                if (!("string" != typeof e || Xe.test(e) || !re.htmlSerialize && Pe.test(e) || !re.leadingWhitespace && Re.test(e) || Qe[($e.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(We, "<$1></$2>");
                    try {
    ...
    oe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && Qt.test(this.nodeName) && !Yt.test(e) && (this.checked || !Le.test(e))
            }).map(function(e, t) {
                var n = oe(this).val();
                ...
                send: function(n, r) {
                    ...
                    o.send(e.hasContent && e.data || null), t = function(n, i) {
                        ...
                        if (t && (i || 4 === o.readyState))
                            if (delete Kt[a], t = void 0, o.onreadystatechange = oe.noop, i) 4 !== o.readyState && o.abort();
                            else {
