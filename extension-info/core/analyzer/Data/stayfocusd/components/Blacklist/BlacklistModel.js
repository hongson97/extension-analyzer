define(["core/Logger", "core/CoreAPI", "components/List/ListModel"], function(t, e, n) {
    return e.Class.extend(n, {
        add: function(t, n, s) {
            return t = "string" == typeof t ? t.toLowerCase() : "", "string" == typeof t && t.indexOf("stayfocusd") >= 0 ? (alert(e.Chrome.Translation.get("cannotBlockStayFocusd")), !1) : this._parent.add(t, n, s)
        },
